...
Dedicated SEO providers are not registered in version 0.1.0. Future SEO additions must use distinct Registry entries and preserve the same evidence, permission, output, and degradation contracts before they become runnable.
