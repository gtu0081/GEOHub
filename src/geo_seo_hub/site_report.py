...
CHARTS = {
    ...
    "funnel": ("诊断准备度漏斗", "Diagnostic readiness funnel", "按阶段展示从 URL 发现到证据准备的保留量与损耗", "Show retained pages and loss across the discovery path"),
    ...
    "links": ("典型页面内链矩阵", "Representative-page link matrix", "观察选中典型页面之间的内部连接", "Inspect connections among selected pages"),
    ...
    "severity": ("问题严重度分布", "Issue severity distribution", "按诊断维度与问题严重度聚合问题", "Group issues by dimension and severity"),
